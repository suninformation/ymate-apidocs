            ...
            DocInfo doc = ReentrantLockHelper.putIfAbsentAsync(docInfoMap, docsId, () -> {
                ...
                if (defaultResponses != null) {
                    ...
                    if (Serializable.class.equals(defaultResponses.pagingType())) {
                        ...
                        docInfo.addResponseProperty(PropertyInfo.create().setName(apisAnn.snakeCase() ? "results_available" : "resultsAvailable").setValue(Boolean.class.getSimpleName()).setDescription(AbstractMarkdown.i18nText(this, "response.results_available", "Paging param: whether the result set is not empty.")));
                    } else {
