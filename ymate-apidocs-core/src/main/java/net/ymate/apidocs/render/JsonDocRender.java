...
/**
 * @author 刘镇 (suninformation@163.com) on 2020/02/09 11:44
 */
public class JsonDocRender extends AbstractDocRender {
    ...
    public String render() throws IOException {
        return JSON.toJSONString(getDocInfo(), SerializerFeature.DisableCircularReferenceDetect, SerializerFeature.PrettyFormat);
    }
}
