...
# Default log level for all instances of SimpleLogger. Must be one of ("trace", "debug", "info", "warn", or "error").
# If not specified, defaults to "info".
#org.slf4j.simpleLogger.defaultLogLevel=info

# Logging detail level for a SimpleLogger instance named "xxxxx". Right-side value must be one of "trace", "debug", "info", "warn", or "error".
# When a SimpleLogger named "xxxxx" is initialized, its level is assigned from this property.
